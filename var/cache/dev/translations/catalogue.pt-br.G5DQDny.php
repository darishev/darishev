...
$catalogue = new MessageCatalogue('pt-br', array (
  ...
  array (
    ...
    'list.title' => 'Agendar comandos',
    'action.delete' => 'Remover',
    'action.execute' => 'Executar',
    'action.edit' => 'Editar',
    'action.new' => 'Novo agendamento',
    'confirm.delete' => 'Deletar permanentemente esta tarefa ?',
    'confirm.execute' => 'Forçar uma execução para esta tarefa ?',
    'action.unlock' => 'Desbloquear tarefa',
    'confirm.unlock' => 'Esta tarefa pode estar em execução. Tem certeza que deseja desbloqueá-la ?',
    'action.search' => 'Procurar',
    'action.list' => 'De volta à lista',
    'action.cancel' => 'Cancelar',
    'detail.title' => 'Agendar comando',
    'detail.name' => 'Nome',
    'detail.command' => 'Comando',
    'detail.arguments' => 'Argumentos',
    'detail.cronExpression' => 'Expressão Cron',
    'detail.logFile' => 'Arquivo de saída',
    'detail.priority' => 'Prioridade',
    'detail.executeImmediately' => 'Execute agora',
    'detail.disabled' => 'Desabilitar',
    'action.save' => 'Salvar',
    'detail.lastExecution' => 'Última execução',
    'detail.lastReturnCode' => 'Último código de saída',
    'detail.actions' => 'Ações',
    'detail.locked' => 'Bloqueado',
    'flash.success' => 'Agendamento salvo com sucesso.',
    'flash.deleted' => 'Agendamento deletado com sucesso.',
    'flash.execute' => 'Comando será executado no próximo "scheduler:execute".',
    'flash.unlocked' => 'Agendamento desbloqueado com sucesso.',
    'label.null' => 'Null',
    'label.true' => 'True',
    'label.false' => 'False',
  ),
  'validators' => 
  array (
    'commandScheduler.validation.cron' => 'Expressão cron não válida.',
  ),
));
