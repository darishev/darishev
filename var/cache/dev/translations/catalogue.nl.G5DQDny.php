...
$catalogue = new MessageCatalogue('nl', array (
  ...
  array (
    ...
    'commandScheduler.validation.cron' => 'Cron expressie is niet juist.',
  ),
  'security' => 
  array (
  ...
  'DukecityCommandScheduler' => 
  array (
    'name' => 'Symfony\'s planner',
    'dateFormat' => 'Y-m-d H:i',
    'list.title' => 'Geplande commando\'s',
    'action.delete' => 'Verwijderen',
    'action.execute' => 'Uitvoeren',
    'action.edit' => 'Wijzigen',
    'action.new' => 'Nieuwe planning',
    'confirm.delete' => 'Deze taak permanent verwijderen?',
    'confirm.execute' => 'Een executie forceren voor deze taak?',
    'action.unlock' => 'Taak ontgrendelen',
    'confirm.unlock' => 'De taak kan aan de gang zijn. Weet u zeker dat u het wilt ontgrendelen?',
    'action.search' => 'Zoeken',
    'action.list' => 'Terug naar lijst',
    'action.cancel' => 'Annuleren',
    'detail.title' => 'Gepland commando',
    'detail.name' => 'Naam',
    'detail.command' => 'Commando',
    'detail.arguments' => 'Argumenten',
    'detail.cronExpression' => 'Cron expressie',
    'detail.logFile' => 'Uitvoerbestand',
    'detail.priority' => 'Prioriteit',
    'detail.executeImmediately' => 'Voer nu uit',
    'detail.disabled' => 'Uitgeschakeld',
    'action.save' => 'Opslaan',
    'detail.lastExecution' => 'Laatste reeks',
    'detail.lastReturnCode' => 'Laatste retournummer',
    'detail.actions' => 'Acties',
    'detail.locked' => 'Vergrendeld',
    'flash.success' => 'Planning succesvol opgeslagen.',
    'flash.deleted' => 'Planning succesvol verwijderd.',
    'flash.execute' => 'Het commando zal worden uitgevoerd tijdens de volgende "scheduler:execute".',
    'flash.unlocked' => 'Planning succesvol ontgrendeld.',
    'label.null' => 'Niet van kracht',
    'label.true' => 'Juist',
    'label.false' => 'Onjuist',
  ),
  'EasyAdminBundle' => 
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'commandScheduler.validation.cron' => 'The cron expression is not valid.',
  ),
  'security' => 
  array (
  ...
  array (
    ...
    'action.edit' => 'Edit',
    'action.new' => 'New scheduling',
    'confirm.delete' => 'Permanently delete this task ?',
    'confirm.execute' => 'Force an execution for this task ?',
    'action.unlock' => 'Unlock task',
    'confirm.unlock' => 'The task may be running. Are you sure you want to unlock it ?',
    'action.search' => 'Search',
    'action.list' => 'Back to list',
    'action.cancel' => 'Cancel',
    'detail.title' => 'Scheduled command',
    'detail.name' => 'Name',
    'detail.command' => 'Command',
    'detail.arguments' => 'Arguments',
    'detail.cronExpression' => 'Cron expression',
    'detail.logFile' => 'Output file',
    'detail.priority' => 'Priority',
    'detail.executeImmediately' => 'Execute now',
    'detail.disabled' => 'Disabled',
    'action.save' => 'Save',
    'detail.lastExecution' => 'Last run',
    'detail.lastReturnCode' => 'Last return code',
    'detail.actions' => 'Actions',
    'detail.locked' => 'Locked',
    'detail.nextRun' => 'Next run',
    'flash.success' => 'Scheduling successfully saved.',
    'flash.deleted' => 'Scheduling successfully deleted.',
    'flash.execute' => 'Command -%name%- will be executed during the next "scheduler:execute".',
    'flash.unlocked' => 'Scheduling successfully unlocked.',
    'label.null' => 'Null',
    'label.true' => 'True',
    'label.false' => 'False',
  ),
