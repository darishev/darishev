...
$catalogue = new MessageCatalogue('es', array (
  ...
  array (
    ...
    'commandScheduler.validation.cron' => 'Definición de cron inválida.',
  ),
  'security' => 
  array (
  ...
  array (
    'name' => 'Planificador de tareas de Symfony',
    'dateFormat' => 'd-m-Y H:i',
    'list.title' => 'Tareas programadas',
    'action.delete' => 'Eliminar',
    'action.execute' => 'Ejecutar',
    'action.edit' => 'Editar',
    'action.new' => 'Nueva tarea',
    'confirm.delete' => '¿Borrar permanentemente esta tarea?',
    'confirm.execute' => '¿Forzar la ejecución de esta tarea?',
    'action.unlock' => 'Desbloquear tarea',
    'confirm.unlock' => 'La tarea puede estar corriendo ¿Está seguro que desea desbloquearla?',
    'action.search' => 'Buscar',
    'action.list' => 'Volver a la lista',
    'action.cancel' => 'Cancelar',
    'detail.title' => 'Tarea programada',
    'detail.name' => 'Nombre',
    'detail.command' => 'Comando',
    'detail.arguments' => 'Parametros',
    'detail.cronExpression' => 'Definición del cron',
    'detail.logFile' => 'Archivo de log',
    'detail.priority' => 'Prioridad',
    'detail.executeImmediately' => 'Ejecutar ahora',
    'detail.disabled' => 'Deshabilitar',
    'action.save' => 'Guardar',
    'detail.lastExecution' => 'Última ejecución',
    'detail.lastReturnCode' => 'Ultimo código retorno',
    'detail.actions' => 'Acciones',
    'detail.locked' => 'Bloqueado',
    'flash.success' => 'Tarea guardada exitosamente.',
    'flash.deleted' => 'Tarea eliminada exitosamente',
    'flash.execute' => 'El comando será ejecutado en el siguiente "scheduler:execute".',
    'flash.unlocked' => 'Tarea desbloqueada exitosamente.',
    'label.null' => 'Null',
    'label.true' => 'True',
    'label.false' => 'False',
  ),
