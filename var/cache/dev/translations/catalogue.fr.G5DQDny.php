...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'commandScheduler.validation.cron' => 'Expression cron non valide.',
  ),
  'security' => 
  array (
  ...
  array (
    ...
    'list.title' => 'Tâches planifiées',
    'action.delete' => 'Supprimer',
    'action.execute' => 'Executer',
    'action.edit' => 'Modifier',
    'action.new' => 'Nouvelle planification',
    'confirm.delete' => 'Supprimer définitivement cette planification ?',
    'confirm.execute' => 'Forcer une exécution de cette commande ?',
    'action.unlock' => 'Déverrouiller la planification',
    'confirm.unlock' => 'Le traitement est peut-être en cours d\'exécution. Etes-vous sur de vouloir le déverrouiller ?',
    'action.search' => 'Rechercher',
    'action.list' => 'Retour à la liste',
    'action.cancel' => 'Annuler',
    'detail.title' => 'Tâche planifiée',
    'detail.name' => 'Nom',
    'detail.command' => 'Commande',
    'detail.arguments' => 'Arguments',
    'detail.cronExpression' => 'Expression cron',
    'detail.logFile' => 'Nom du fichier de log',
    'detail.priority' => 'Priorité',
    'detail.executeImmediately' => 'Exécuter maintenant',
    'detail.disabled' => 'Désactiver',
    'action.save' => 'Enregistrer',
    'detail.lastExecution' => 'Dernière exécution',
    'detail.lastReturnCode' => 'Dernier code retour',
    'detail.actions' => 'Actions',
    'detail.locked' => 'Verrouillé',
    'flash.success' => 'Planification sauvegardée avec succés.',
    'flash.deleted' => 'Planification supprimée avec succés.',
    'flash.execute' => 'Le traitement sera exécuté lors de la prochaine vérification (scheduler:execute).',
    'flash.unlocked' => 'Traitement déverrouillé avec succès.',
    'label.null' => 'Aucun',
    'label.true' => 'Oui',
    'label.false' => 'Non',
  ),
