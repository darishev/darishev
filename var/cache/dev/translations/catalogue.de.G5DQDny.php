...
$catalogue = new MessageCatalogue('de', array (
  ...
  array (
    ...
    'commandScheduler.validation.cron' => 'Ungültiger Cron-Ausdruck.',
  ),
  'security' => 
  array (
  ...
  array (
    'name' => 'Symfony\'s Aufgaben-Planer',
    'dateFormat' => 'd.m.Y H:i',
    'list.title' => 'Geplante Aufgaben',
    'action.delete' => 'Löschen',
    'action.execute' => 'Ausführen',
    'action.edit' => 'Bearbeiten',
    'action.new' => 'Neue Aufgabe',
    'confirm.delete' => 'Diese Aufgabe unwiderruflich löschen?',
    'confirm.execute' => 'Die Ausführung dieser Aufgabe erzwingen?',
    'action.unlock' => 'Aufgabe entsperren',
    'confirm.unlock' => 'Die Aufgabe könnte gerade ausgeführt werden. Möchtest du sie wirklich entsperren?',
    'action.search' => 'Suche',
    'action.list' => 'Zurück zur Liste',
    'action.cancel' => 'Stornieren',
    'detail.title' => 'Geplante Aufgabe',
    'detail.name' => 'Name',
    'detail.command' => 'Kommando',
    'detail.arguments' => 'Argumente',
    'detail.cronExpression' => 'Cron-Ausdruck',
    'detail.logFile' => 'Ausgabedatei',
    'detail.priority' => 'Priorität',
    'detail.executeImmediately' => 'Jetzt ausführen',
    'detail.disabled' => 'Deaktivieren',
    'action.save' => 'Speichern',
    'detail.lastExecution' => 'Letzte Ausführung',
    'detail.lastReturnCode' => 'Letzter Status-Code',
    'detail.actions' => 'Aktionen',
    'detail.locked' => 'Verschlossen',
    'detail.nextRun' => 'Nächste Ausführung',
    'flash.success' => 'Aufgabe erfolgreich gespeichert.',
    'flash.deleted' => 'Aufgabe erfolgreich gelöscht.',
    'flash.execute' => 'Aufgabe -%{name}- wird beim nächsten "scheduler:execute" ausgeführt.',
    'flash.unlocked' => 'Aufgabe erfolgreich entsperrt.',
    'label.null' => 'Null',
    'label.true' => 'True',
    'label.false' => 'False',
  ),
