...
class getUnlockCommand_LazyService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['.Dukecity\\CommandSchedulerBundle\\Command\\UnlockCommand.lazy'] = new \Symfony\Component\Console\Command\LazyCommand('scheduler:unlock', [], 'Unlock one or all scheduled commands that have surpassed the lock timeout.', false, function () use ($container): \Dukecity\CommandSchedulerBundle\Command\UnlockCommand {
            return ($container->privates['Dukecity\\CommandSchedulerBundle\\Command\\UnlockCommand'] ?? $container->load('getUnlockCommandService'));
        });
    }
}
