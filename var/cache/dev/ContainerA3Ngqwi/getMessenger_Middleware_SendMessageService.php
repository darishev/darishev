...
class getMessenger_Middleware_SendMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['messenger.middleware.send_message'] = $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['App\\Message\\Interfaces\\MessageHighInterface' => [0 => 'async_priority_high'], 'App\\Message\\Interfaces\\MessageLowInterface' => [0 => 'async_priority_low']], ($container->privates['.service_locator.x_Xm.O6'] ?? $container->load('get_ServiceLocator_XXm_O6Service'))), ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()));
