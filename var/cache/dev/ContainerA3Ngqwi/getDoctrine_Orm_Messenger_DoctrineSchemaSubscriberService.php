...
class getDoctrine_Orm_Messenger_DoctrineSchemaSubscriberService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['doctrine.orm.messenger.doctrine_schema_subscriber'] = new \Symfony\Bridge\Doctrine\SchemaListener\MessengerTransportDoctrineSchemaSubscriber(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['messenger.transport.async_priority_high'] ?? $container->load('getMessenger_Transport_AsyncPriorityHighService'));
            yield 1 => ($container->privates['messenger.transport.async_priority_low'] ?? $container->load('getMessenger_Transport_AsyncPriorityLowService'));
            yield 2 => ($container->privates['messenger.transport.failed'] ?? $container->load('getMessenger_Transport_FailedService'));
        }, 3));
    }
}
