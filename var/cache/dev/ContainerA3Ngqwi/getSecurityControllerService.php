...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.JC.qEFX'] ?? $container->load('get_ServiceLocator_JC_QEFXService'))->withContext('App\\Controller\\SecurityController', $container));
