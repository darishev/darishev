...
class getCommentCrudControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.fVPZPtt'] ?? $container->load('get_ServiceLocator_FVPZPttService'))->withContext('App\\Controller\\Admin\\CommentCrudController', $container));
