...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'Dukecity\\CommandSchedulerBundle\\Command\\ExecuteCommand' => ['privates', '.Dukecity\\CommandSchedulerBundle\\Command\\ExecuteCommand.lazy', 'getExecuteCommand_LazyService', true],
            'Dukecity\\CommandSchedulerBundle\\Command\\MonitorCommand' => ['privates', '.Dukecity\\CommandSchedulerBundle\\Command\\MonitorCommand.lazy', 'getMonitorCommand_LazyService', true],
            'Dukecity\\CommandSchedulerBundle\\Command\\ListCommand' => ['privates', '.Dukecity\\CommandSchedulerBundle\\Command\\ListCommand.lazy', 'getListCommand_LazyService', true],
            'Dukecity\\CommandSchedulerBundle\\Command\\UnlockCommand' => ['privates', '.Dukecity\\CommandSchedulerBundle\\Command\\UnlockCommand.lazy', 'getUnlockCommand_LazyService', true],
            'Dukecity\\CommandSchedulerBundle\\Command\\AddCommand' => ['privates', '.Dukecity\\CommandSchedulerBundle\\Command\\AddCommand.lazy', 'getAddCommand_LazyService', true],
            'Dukecity\\CommandSchedulerBundle\\Command\\RemoveCommand' => ['privates', '.Dukecity\\CommandSchedulerBundle\\Command\\RemoveCommand.lazy', 'getRemoveCommand_LazyService', true],
            'Dukecity\\CommandSchedulerBundle\\Command\\StartSchedulerCommand' => ['privates', '.Dukecity\\CommandSchedulerBundle\\Command\\StartSchedulerCommand.lazy', 'getStartSchedulerCommand_LazyService', true],
            'Dukecity\\CommandSchedulerBundle\\Command\\StopSchedulerCommand' => ['privates', '.Dukecity\\CommandSchedulerBundle\\Command\\StopSchedulerCommand.lazy', 'getStopSchedulerCommand_LazyService', true],
            'Dukecity\\CommandSchedulerBundle\\Command\\TestCommand' => ['privates', '.Dukecity\\CommandSchedulerBundle\\Command\\TestCommand.lazy', 'getTestCommand_LazyService', true],
            ...
            'Dukecity\\CommandSchedulerBundle\\Command\\ListCommand' => '?',
            'Dukecity\\CommandSchedulerBundle\\Command\\UnlockCommand' => '?',
            'Dukecity\\CommandSchedulerBundle\\Command\\AddCommand' => '?',
            'Dukecity\\CommandSchedulerBundle\\Command\\RemoveCommand' => '?',
            ...
            'Dukecity\\CommandSchedulerBundle\\Command\\TestCommand' => '?',
