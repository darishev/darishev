...
class getCommandBus_Middleware_DoctrinePingConnectionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['command_bus.middleware.doctrine_ping_connection'] = new \Symfony\Bridge\Doctrine\Messenger\DoctrinePingConnectionMiddleware(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
